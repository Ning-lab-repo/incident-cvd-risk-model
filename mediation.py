...
"""
合并分析流程：(TableA -> TableB -> TableC) x 4个暴露变量
1. TableA (线性回归): [Exposure] -> Protein
2. TableB (Cox 回归): Protein -> Outcome (使用 TableA 结果筛选蛋白)
3. TableC (中介分析): [Exposure] -> Protein -> Outcome (使用 TableB 结果筛选蛋白)
